...
public class initialFrame extends JFrame{
	...
	public void initial()
	{
		...
		Create.addActionListener(new //controller
		         ActionListener()
		         {
		            public void actionPerformed(ActionEvent event)
		            {
		...
		JTextArea Test1 = new JTextArea(arrayOfMonths[cal.get(Calendar.MONTH)] + " " + cal.get(Calendar.YEAR));
		...
		JTextArea Test2 = new JTextArea(arrayOfDays[ cal.get(Calendar.DAY_OF_WEEK)-1 ] + " " + arrayOfMonths[cal.get(Calendar.MONTH)] + " " + cal.get(Calendar.DAY_OF_MONTH) );
